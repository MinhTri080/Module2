...
//        int numBer = 291;
//        int firts = numBer/100;
//        int second = (numBer%100)/10;
//        int third = numBer%10;
//        String resutl = null;
//
//        if (numBer<0 || numBer >1000){
//            System.out.println("ngoài phạm vi đếm");
//        }
//        if (numBer>0 && numBer <10){
//            resutl = one2nine(numBer);
//            System.out.println(resutl);
//            return;
//        }
//        if (numBer>=10 && numBer <20){
//            resutl = _10_to_19_(resutl);
//            System.out.println(resutl);
//            return;
//        }
//        if (numBer >=20 && numBer <100){
//            if (third !=0){
//                resutl = _20_to_99_(second)+ ""+ one2nine(third);
//                System.out.println(resutl);
//            }else {
//                resutl = _20_to_99_(second);
//                System.out.println(resutl);
//            }
//            return;
//
...
//            if (third ==0){
//                if (second ==0){
//                    resutl=_100_to_999_(firts);
//                    System.out.println(resutl);
//                }
//                if (second<2 && second >0){
//                    resutl = _100_to_999_(firts)+ "and"+_10_to_19_(third);
//                    System.out.println(resutl);
//                }else
//                    if(second>=2){
//                        resutl = _100_to_999_(firts) +"and"+ _20_to_99_(second);
//                        System.out.println(resutl);
//                    }
//                    else
//                        if (second==0){
//                            resutl = _100_to_999_(firts)+ "and"+ one2nine(third);
//                            System.out.println(resutl);
//                            return;
//                        }
//            }
//            else
//                if (second < 2) {
//                resutl = _100_to_999(firts) + " and " + _10_to_19(third);
//                System.out.println(resutl);
//
//        }else {
//                    resutl = _100_to_999(firts) + " and " + _20_to_99(second) + " and " + one2Nine(third);
//                    System.out.println(resutl);
//                }
//            return;
//
